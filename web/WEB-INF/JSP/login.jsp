                            ...
                            <div class="mt-6">
                                <form action="LoginServlet" method="POST" class="space-y-6">
                                    <div>
                                        ...
                                        <div class="mt-1">
                                            <input id="email" name="username" type="text" autocomplete="username" required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" />
                                        </div>
                                    </div>
