                            ...
                            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg fade-in">
                                <table class="min-w-full divide-y divide-gray-200">
                                    <thead class="bg-gray-50">
                                        <tr class="text-2xl">
                                            <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-wider ">Room</th>
                                            <th scope="col" class="px-6 py-3 text-left text-sm font-medium text-gray-500 uppercase tracking-wider">Customer Information</th>
                                    ...
                                    <form action="<%= Routers.BOOKING_ORDERS_SERVLET%>" method="POST" >
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="flex items-center">
                                                ...
                                                <div class="ml-4">
                                                    <div class="text-sm font-medium text-gray-900">History ID: #<%= historyDetail.getHistory().getHistoryId()%></div>
                                                    <div class="text-sm font-medium text-gray-900"><%= historyDetail.getRoomType().getRoomName()%> #<%= historyDetail.getRoom().getRoomId()%></div>
                                        ...
                                        <td class="px-6 py-4">
                                            <textarea rows="4" name="message" id="message" class="focus:ring-rose-500 focus:border-rose-500 block sm:text-sm rounded-md w-48" placeholder="Enter message here"><%= historyDetail.getHistory().getMessage()%></textarea>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <select id="historyStatus" name="historyStatus" class="cursor-pointer mt-1 block pl-3 pr-10 py-2 text-base border-opacity-20 border-gray-900 focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm rounded-md border-2">
                                                <%
